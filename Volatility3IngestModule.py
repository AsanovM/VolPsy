...
from org.sleuthkit.datamodel import ReadContentInputStream, BlackboardArtifact, BlackboardAttribute
...
class Vol3IngestModuleFactory(IngestModuleFactoryAdapter):
    ...
    def createDataSourceIngestModule(self, settings):
        ...
        # Update diagnostics after OS detection
        self._write_run_diagnostics(True)
